...
* Current validation script checks YAML syntax, required fields, duplicate IDs, and filename-ID consistency warnings.
...
* Current data focuses on early Tiantai lineage, core Tiantai works, key doctrinal terms, regional branches, timelines, and relation records.
